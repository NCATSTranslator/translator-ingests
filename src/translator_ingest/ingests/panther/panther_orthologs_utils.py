...
def _resolve_gene_curie(col_name: str) -> pl.Expr:
    """
    Build a polars expression that supersedes former parse_gene_info() utility method
    by implementing CURIE resolution logic for a given polars column (Gene or Ortholog).
