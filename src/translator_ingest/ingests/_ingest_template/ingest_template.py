...
# query results into records for the transform. It should not be used for creating Entities or Associations.
#
...
# transformation logic generating Entities (nodes) and Associations (edges) from source data.
#
# The transform_record function takes a single record, a dictionary typically corresponding to a row in a source data
# file, and returns a tuple of Entities and Associations. Any number of Entities and/or Associations can be returned.
...
# corresponding to all the rows in a source data file, and returns an iterable of tuples of Entities and Associations.
# Any number of Entities and/or Associations can be returned in as many separate tuples as desired. This offers
# significant flexibility for ingest implementers. Results can be returned all at once, in batches, or using a generator
# for streaming.
