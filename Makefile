...
SOURCES ?= alliance chembl ctd ctkp dakp dgidb diseases drug_rep_hub gene2phenotype go_cam goa hpoa icees intact ncbi_gene panther semmeddb sider tmkp ttd ubergraph 
