...
3. [Resource Ingest Guide Schema Repo](https://github.com/biolink/resource-ingest-guide-schema): Holds a linkML-based schema for authoring/validating RIGs, and schema documentation.
   - **RIG Schema**: linkML schema for authoring/validating RIG documents ([yaml](https://github.com/biolink/resource-ingest-guide-schema/blob/main/src/resource_ingest_guide_schema/schema/resource_ingest_guide_schema.yaml)) ([docs site](https://biolink.github.io/resource-ingest-guide-schema/))
...
4. **Source Ingest Tickets** **_(as needed)_**: If content or modeling questions arise, create a `source-ingest` ticket in the DINGO repo ([Source Ingest Issues](https://github.com/NCATSTranslator/Data-Ingest-Coordination-Working-Group/issues?q=state%3Aopen%20label%3A%22source%20ingest%22))
