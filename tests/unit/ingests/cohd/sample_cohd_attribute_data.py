"""
Sample COHD attributes data for unit testing
(segregated to help in main unit test module readability)

Additional character strings in this file could be reformatted for readability
but doing this would be tedious, and would not change their semantic content
thus we leave things the way they are for now
"""
...
'''
    {
        "attribute_source": "infores:cohd",
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing an observed-expected frequency analysis on a single pair of concepts",
...
'''
    {
        "attribute_source": "infores:cohd",
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing a relative frequency analysis on a single pair of concepts",
        "value": "Relative to SNOMEDCT:60108003: 1.091 [0.200, 5.500]; Relative to CPT:73540: 0.013 [0.004, 0.026]",
        ...
        "attributes": [
            {
                ...
                "value_type_id": "EDAM:data_1772",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency, relative to the subject node (SNOMEDCT:60108003)."
            },
            {
...
'''
    {
        ...
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing the initial count of concepts",
        "value": "UMLS:C0160047: 11; CPT:73030: 29261; pair: 16",
        "value_type_id": "biolink:ConceptCountAnalysisResult",
        "value_url": "https://github.com/NCATSTranslator/Translator-All/wiki/COHD-KP",
        "attributes": [
            {
            ...
            },
            {
                ...
                "value_type_id": "EDAM:data_0006",
                "attribute_source": "infores:cohd",
                "description": "Observed concept count of the subject node (UMLS:C0160047)"
            },
            {
                "attribute_type_id": "biolink:concept_count_object",
                "original_attribute_name": "concept_count_object",
                ...
                "value_type_id": "EDAM:data_0006",
                "attribute_source": "infores:cohd",
                "description": "Observed concept count of the object node (CPT:73030)"
            },
            {
                "attribute_type_id": "biolink:dataset_count",
                "original_attribute_name": "patient_count",
...
'''
    {
        ...
        "attributes": [
            ...
            },
            {
                "attribute_type_id": "biolink:ln_ratio_confidence_interval",
                "original_attribute_name": "ln_ratio_confidence_interval",
                "value": [3.3254987202521264, 5.150048012303173],
                "value_type_id": "EDAM:data_0951",
                "attribute_source": "infores:cohd",
                "description": "Observed-expected frequency ratio 99.0% confidence interval"
            },
...
'''
    {
        ...
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing a relative frequency analysis on a single pair of concepts",
        "value": "Relative to UMLS:C0160047: 1.455 [0.350, 6.750]; Relative to CPT:73030: 0.001 [0.000, 0.001]",
        "value_type_id": "biolink:RelativeFrequencyAnalysisResult",
        "value_url": "https://github.com/NCATSTranslator/Translator-All/wiki/COHD-KP",
        "attributes": [
            {
                ...
                "value_type_id": "EDAM:data_1772",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency, relative to the subject node (UMLS:C0160047)."
            },
            {
                "attribute_type_id": "biolink:relative_frequency_subject_confidence_interval",
                "original_attribute_name": "relative_freq_subject_confidence_interval",
            ...
            },
            {
                "attribute_type_id": "biolink:relative_frequency_object",
                "original_attribute_name": "relative_frequency_object",
                "value": 0.000546802911725505,
                "value_type_id": "EDAM:data_1772",
                "attribute_source": "infores:cohd",
                 "description": "Relative frequency, relative to the object node (CPT:73030)."
            },
            {
                "attribute_type_id": "biolink:relative_frequency_object_confidence_interval",
                "original_attribute_name": "relative_freq_object_confidence_interval", 
                "value": [0.00023566643100023565, 0.000936816904340585],
                "value_type_id": "EDAM:data_0951",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency (object) 99.0% confidence interval"
            },
            {
                "attribute_type_id": "biolink:supporting_data_set",
                "original_attribute_name": "dataset_id", "value": "COHD:dataset_1",
                "value_type_id": "EDAM:data_1048", "attribute_source": "infores:cohd",
                "description": "Dataset ID within COHD"
            },
            {
                "attribute_type_id": "biolink:knowledge_level",
...
'''
    {
        ...
        "attributes": [
            ...
            },
            {
                "attribute_type_id": "biolink:total_sample_size",
                "original_attribute_name": "concept_pair_count",
                "value": 16, "value_type_id": "EDAM:data_0006",
                "attribute_source": "infores:cohd",
                "description": "Observed concept count between the pair of subject and object nodes"
            },
            {
...
'''
    {
        ...
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing the initial count of concepts",
        "value": "MONDO:0000888: 11; CPT:99232: 75532; pair: 19",
        "value_type_id": "biolink:ConceptCountAnalysisResult",
        "value_url": "https://github.com/NCATSTranslator/Translator-All/wiki/COHD-KP",
        "attributes": [
            {
            ...
            },
            {
                ...
                "value_type_id": "EDAM:data_0006",
                "attribute_source": "infores:cohd",
                "description": "Observed concept count of the subject node (MONDO:0000888)"
            },
            {
                "attribute_type_id": "biolink:concept_count_object",
                "original_attribute_name": "concept_count_object",
                ...
                "value_type_id": "EDAM:data_0006",
                "attribute_source": "infores:cohd",
                "description": "Observed concept count of the object node (CPT:99232)"
            },
            {
                "attribute_type_id": "biolink:dataset_count",
                "original_attribute_name": "patient_count",
...
'''
    {
        ...
        "attributes": [
            ...
            },
            {
                "attribute_type_id": "biolink:ln_ratio_confidence_interval",
                "original_attribute_name": "ln_ratio_confidence_interval",
                "value": [2.5595194408846957, 4.323108033146054],
                "value_type_id": "EDAM:data_0951",
                "attribute_source": "infores:cohd",
                "description": "Observed-expected frequency ratio 99.0% confidence interval"
            },
...
'''
    {
        ...
        "attribute_type_id": "biolink:has_supporting_study_result",
        "description": "A study result describing a relative frequency analysis on a single pair of concepts",
        "value": "Relative to MONDO:0000888: 1.727 [0.450, 7.750]; Relative to CPT:99232: 0.000 [0.000, 0.000]",
        "value_type_id": "biolink:RelativeFrequencyAnalysisResult",
        "value_url": "https://github.com/NCATSTranslator/Translator-All/wiki/COHD-KP",
        "attributes": [
            {
                ...
                "value_type_id": "EDAM:data_1772",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency relative to the subject node (MONDO:0000888)."
            },
            {
                "attribute_type_id": "biolink:relative_frequency_subject_confidence_interval",
                "original_attribute_name": "relative_freq_subject_confidence_interval",
            ...
            },
            {
                "attribute_type_id": "biolink:relative_frequency_object",
                "original_attribute_name": "relative_frequency_object",
                "value": 0.00025154901233914105,
                "value_type_id": "EDAM:data_1772",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency, relative to the object node (CPT:99232)."
            },
            {
                "attribute_type_id": "biolink:relative_frequency_object_confidence_interval",
                "original_attribute_name": "relative_freq_object_confidence_interval",
                "value": [0.00011804672026862187, 0.00041430003341129303],
                "value_type_id": "EDAM:data_0951",
                "attribute_source": "infores:cohd",
                "description": "Relative frequency (object) 99.0% confidence interval"
            },
