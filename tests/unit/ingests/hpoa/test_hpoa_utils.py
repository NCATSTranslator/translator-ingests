...
@pytest.mark.parametrize("query", [-1, 101])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (  # query 4 - exact matches to global lower bounds should be sent back accurately
            ...
            Frequency(
                frequency_qualifier="HP:0040285", has_percentage=0.0, has_quotient=0.0, has_count=None, has_total=None
            ),
        ),
        (  # query 5 - exact matches to lower bounds should be sent back accurately
            ...
            Frequency(
                frequency_qualifier="HP:0040283", has_percentage=5.0, has_quotient=0.05, has_count=None, has_total=None
            ),
        ),
        (  # query 6 - matches within percentage range bounds should be sent back accurately
            ...
            # FrequencyHpoTerm(curie="HP:0040283", name="Occasional", lower=5, upper=29),
            Frequency(
                frequency_qualifier="HP:0040283", has_percentage=17.0, has_quotient=0.17, has_count=None, has_total=None
            ),
        ),
        (  # query 7 - exact matches to upper bounds should be sent back accurately
            ...
            # FrequencyHpoTerm(curie="HP:0040283", name="Occasional", lower=5, upper=29),
            Frequency(
                frequency_qualifier="HP:0040283", has_percentage=29.0, has_quotient=0.29, has_count=None, has_total=None
            ),
        ),
        (  # query 8 - exact matches to global upper bounds should be sent back accurately
            ...
            Frequency(
                frequency_qualifier="HP:0040280", has_percentage=100.0, has_quotient=1.0, has_count=None, has_total=None
            ),
        ),
        (  # query 9 - rounds down if decimal value < 0.5 of above an upper bound
            ...
            Frequency(
                frequency_qualifier="HP:0040282", has_percentage=79.4, has_quotient=0.79, has_count=None, has_total=None
            ),
        ),
        (  # query 10 - rounds upwards if decimal value >= 0.5 above an upper bound
            ...
            Frequency(
                frequency_qualifier="HP:0040281", has_percentage=79.5, has_quotient=0.80, has_count=None, has_total=None
            ),
        ),
        (  # query 11 - if a valid 'Frequency' HP ontology term is
            ...
            Frequency(
                frequency_qualifier="HP:0040282", has_percentage=None, has_quotient=None, has_count=None, has_total=None
            ),
        ),
        (  # query 12 - division ratios converted to percentages (i.e., 7/13 ~ 53.8%) that match
            ...
            # FrequencyHpoTerm(curie="HP:0040282", name="Frequent", lower=30, upper=79),
            Frequency(
                frequency_qualifier="HP:0040282", has_percentage=54.0, has_quotient=0.54, has_count=7, has_total=13
            ),
        ),
        (  # query 13 - obligate percentage value
            ...
            # FrequencyHpoTerm(curie="HP:0040280", name="Obligate", lower=100, upper=100),
            Frequency(
                frequency_qualifier="HP:0040280", has_percentage=100.0, has_quotient=1.0, has_count=1, has_total=1
            ),
        ),
        (  # query 14 - still an obligate percentage value
            ...
            # FrequencyHpoTerm(curie="HP:0040280", name="Obligate", lower=100, upper=100),
            Frequency(
                frequency_qualifier="HP:0040280", has_percentage=100.0, has_quotient=1.0, has_count=2, has_total=2
            ),
        ),
        (  # query 15 - frequent ratio/percentage value
            ...
            # FrequencyHpoTerm(curie="HP:0040282", name="Frequent", lower=30, upper=79),
            Frequency(
                frequency_qualifier="HP:0040282", has_percentage=50.0, has_quotient=0.5, has_count=1, has_total=2
            ),
        ),
    ],
)
