...
# ── Fixtures: one per edge type declared in ctkp_rig.yaml / ctkp.py ────────
EDGE_FIXTURES = [
    {
        "association_class": EntityToDiseaseAssociation,
        "params": {
            "id": "uuid:ctkp-test-entity-disease",
    ...
    },
    {
        ...
        "params": {
            "id": "uuid:ctkp-test-entity-phenotype",
