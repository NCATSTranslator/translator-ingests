...
from translator_ingest.ingests.panther.panther import get_latest_version, transform_gene_to_gene_orthology
...
NODE_TEST_SLOTS = ("id", "in_taxon", "category")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (  # Query 3 - Regular record, HUMAN (HGNC identified gene) to RAT ortholog row test
            ...
            [
                {"id": "HGNC:11477", "in_taxon": ["NCBITaxon:9606"], "category": ["biolink:Gene"]},
                {"id": "RGD:1564893", "in_taxon": ["NCBITaxon:10116"], "category": ["biolink:Gene"]},
                {"id": "PANTHER.FAMILY:PTHR12434", "category": ["biolink:GeneFamily"]},
            ],
            ...
            [
                {
                    ...
                    "sources": [{"resource_role": "primary_knowledge_source", "resource_id": "infores:panther"}],
        ...
        (  # Query 4 - Regular record, HUMAN (HGNC identified gene) to RAT ortholog row test
            ...
            # Captured node contents
            [
                {"id": "ENSEMBL:ENSG00000275949", "in_taxon": ["NCBITaxon:9606"], "category": ["biolink:Gene"]},
                {"id": "MGI:99431", "in_taxon": ["NCBITaxon:10090"], "category": ["biolink:Gene"]},
                {"id": "PANTHER.FAMILY:PTHR11711", "category": ["biolink:GeneFamily"]},
            ],
            # Captured edge contents
            [
                {
        ...
        (  # Query 5 - Regular record, HUMAN (non-canonical gene identifier) to RAT ortholog row test
            ...
            # Captured node contents
            [
                {"id": "UniProtKB:A6NNC1", "in_taxon": ["NCBITaxon:9606"], "category": ["biolink:Gene"]},
                {"id": "RGD:7561849", "in_taxon": ["NCBITaxon:10116"], "category": ["biolink:Gene"]},
                {"id": "PANTHER.FAMILY:PTHR15566", "category": ["biolink:GeneFamily"]},
            ],
            # Captured edge contents
            [
                {
