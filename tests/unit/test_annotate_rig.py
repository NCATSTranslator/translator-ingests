...
@pytest.mark.parametrize(
    ...
    [
        (  # Query 0 - insert a value (a list) for an empty property in the data structure
            {
                "source_info": {
                    "citations": None,
                    "terms_of_use_info": {"terms_of_use_url": "https://hpo.jax.org/license"},
                }
            },
        ...
        (  # Query 1 - insert a property plus value (a list) for
            ...
            {"source_info": {"terms_of_use_info": {"terms_of_use_url": "https://hpo.jax.org/license"}}},
            ["source_info", "citations"],
            ["https://doi.org/10.1093/nar/gkaa1043"],
            {
                "source_info": {
        ...
        (  # Query 3 - insert a value (a list of dictionaries) at an empty property
            ...
            [
                {"property": "biolink:subject_feature_name", "value_range": "str"},
                {"property": "biolink:object_feature_name", "value_range": "str"},
            ],
            {
                "target_info": {
                    "edge_type_info": [
