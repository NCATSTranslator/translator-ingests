...
rootdir :=`pwd`
sources := "alliance chembl cohd ctd ctkp dakp dgidb diseases gene2phenotype go_cam goa hpoa icees intact ncbi_gene panther semmeddb sider tmkp ttd ubergraph"
